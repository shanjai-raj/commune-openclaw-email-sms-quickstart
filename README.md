...
[![Commune](https://img.shields.io/badge/Commune-email-blue)](https://commune.email)
...
[Commune](https://commune.email) provides real email inboxes via a REST API. Every inbox is RFC 5322 compliant — replies thread correctly in any email client. Built-in spam filtering and prompt injection detection protect your agent from malicious inbound content.
